;;; fodder-theme.el --- fodder
;;; Version: 1.0
;;; Commentary:
;;; A theme called fodder
;;; Code:

(deftheme fodder "DOCSTRING for fodder")
  (custom-theme-set-faces 'fodder
...
(provide-theme 'fodder)

;;; fodder-theme.el ends here
